...
const Product = ({post}) => {
  ...
  return (
  <div className="flex flex-col justify-between items-center hover:scale-110 transition duration-300 ease-in gap-5 p-4 mt-10 ml-5 rounded-xl outline shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] hover:shadow-[0px_-50px_100px_80px_rgba(0,0,0,0.08)]">
    <div>
